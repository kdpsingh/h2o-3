...
#' @seealso \code{\link{h2o.gbm}} and  \code{\link{h2o.randomForest}} for model
#'          generation in h2o.
predict_feature_frequencies.H2OModel <- function(object, newdata, ...) {
    if (missing(newdata)) {
        stop("predictions with a missing `newdata` argument is not implemented yet")
    }
...
#' @rdname predict_feature_frequencies.H2OModel
#' @export
h2o.predict_feature_frequencies <- predict_feature_frequencies.H2OModel
