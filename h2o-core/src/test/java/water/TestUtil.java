...
import water.fvec.Frame.CSVStreamParams;
...
public class TestUtil extends Iced {
  ...
  public static void writeFrameToCSV(String fileNameWithPath, Frame h2oframe, boolean header, boolean hex_string)
          throws IOException {
    CSVStreamParams fileParams = new CSVStreamParams();
    fileParams.setHeaders(header);
    fileParams.setHexString(hex_string);
    InputStream frameToStream = h2oframe.toCSV(fileParams);    // read in frame as Inputstream
